...
public class Queries {
	...
	{
		String x = "SELECT * FROM "+ databaseName +".`shipping_address` where customer_id = '"+customer_id+"' and address_id = '" + address_id + "';"; 
		return x;
	}
	...
	public static String CONFIRM_ORDER(String order_id, String status)
	{
